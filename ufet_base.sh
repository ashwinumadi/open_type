...
#SBATCH --gres=gpu:1
#SBATCH --output=Crowd_test_bin4-%j.out
...
python3 main.py crowd_v4_test -lstm_type single -enhanced_mention -add_crowd -mode test -reload_model_name crowd_v4 -eval_data crowd/bin_4.json -load
