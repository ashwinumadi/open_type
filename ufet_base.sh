...
#python3 main.py crowd_v1 -lstm_type single -goal open -enhanced_mention -train_data crowd/train.json -dev_data crowd/dev.json -num_epoch 5 -only_crowd
python3 main.py crowd_v1_test -lstm_type single -enhanced_mention -add_crowd -mode test -reload_model_name crowd_v1.pt -eval_data crowd/test.json -load
